...
import { DrawCardsService } from '../../draw-card.service';

@Component({
  selector: 'app-deck-card-block',
  templateUrl: './deck-card-block.component.html',
  styleUrls: ['./deck-card-block.component.css'],
  animations: [
...
export class DeckCardBlockComponent {
